/* MijnSerenity 7.3.2 — Development Mode */
(()=>{
  'use strict';
  ...
  function installDashboardCard(){
    ...
    card.innerHTML=`<span class="development-local-pill">🧪 TESTOMGEVING</span><h3>Veilig verder bouwen</h3><p class="small">Deze branch gebruikt alleen lokale voorbeeldgegevens. Supabase, productieaccounts en echte foto-opslag worden niet benaderd.</p><div class="development-dashboard-grid"><div><span>Data</span><strong>Lokaal op dit apparaat</strong></div><div><span>Home Assistant</span><strong>Demo of live-koppeling</strong></div><div><span>Opslagverkeer</span><strong>0 GB Supabase</strong></div><div><span>Versie</span><strong>7.3.2 DEV</strong></div></div>`;
