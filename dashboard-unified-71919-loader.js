/* MijnSerenity 8.27.7 — compatibiliteitsbrug voor de voormalige 7.19.19 dashboardloader.
...
(()=>{
'use strict';
if(window.__msDashboardCompat8277)return;
window.__msDashboardCompat8277=true;

const CURRENT_PATH='/start-dashboard-71510.js';
const CURRENT_SRC=`${CURRENT_PATH}?v=827700`;
...
function loadCurrent(){
  ...
  script.async=false;
  script.dataset.ms8277Compatibility='1';
