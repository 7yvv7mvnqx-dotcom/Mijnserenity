...
(()=>{
  ...
  if(!document.getElementById('msAiDestinationCss')){
    const aiCss=document.createElement('link');aiCss.id='msAiDestinationCss';aiCss.rel='stylesheet';aiCss.href='/ai-destination-search.css?v=715520';document.head.appendChild(aiCss);
  }
  const scripts=[
    ...
    ['/ai-destination-search.js?v=715520','msAiDestination71551']
  ];
