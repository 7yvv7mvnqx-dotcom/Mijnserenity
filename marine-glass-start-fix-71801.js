/* MijnSerenity 7.18.1 — start/dashboard rescue */
(()=>{
  'use strict';
  if(window.__msMarineGlassStartFix71801)return;
  window.__msMarineGlassStartFix71801=true;
  const BUILD='7.18.1';
  ...
  function showDashboard(){
    ...
    if(glass){
      ...
      ['ms71510Dashboard','serenityIvms'].forEach(id=>{
        ...
        if(el){el.hidden=false;el.style.removeProperty('display');el.style.removeProperty('visibility');}
      });
    }
