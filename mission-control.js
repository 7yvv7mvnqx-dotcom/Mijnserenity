...
function ms700SystemReport(){
  ...
  return [`MijnSerenity 8.0.0 systeemrapport`,`Datum: ${new Date().toLocaleString('nl-NL')}`,
...
async function ms700BuildBackup(){
  ...
  return {format:'mijnserenity-backup',format_version:1,app_version:'8.0.0',created_at:new Date().toISOString(),
