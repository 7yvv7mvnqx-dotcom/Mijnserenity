...
function ms700SystemReport(){
  ...
  return [`MijnSerenity 7.9.0 systeemrapport`,`Datum: ${new Date().toLocaleString('nl-NL')}`,
...
async function ms700BuildBackup(){
  ...
  return {format:'mijnserenity-backup',format_version:1,app_version:'7.9.0',created_at:new Date().toISOString(),
