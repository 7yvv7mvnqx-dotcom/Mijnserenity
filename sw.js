/* MijnSerenity 8.31.0 — Victron live dashboard cache refresh */
const CACHE_NAME='mijnserenity-8.31.0';
const BUILD='8.31.0';
const TOKEN='831000';
const CORE=[
  '/',
  ...
  `/start-dashboard-8285.js?v=${TOKEN}`,
  `/global-dashboard-nav-8290.js?v=${TOKEN}`,
  `/contessa-start-icon-8290.js?v=${TOKEN}`,
  `/dashboard-unified-71919-loader.js?v=${TOKEN}`,
  `/approved-dashboard-8263.js?v=${TOKEN}`,
  `/approved-dashboard-live-8264.js?v=${TOKEN}`,
  `/dashboard-victron-live-8310.js?v=${TOKEN}`,
  `/victron-tank-alarm-8278.js?v=${TOKEN}`,
  ...
  '/serenity-dashboard-boat-20260926.webp?v=831000',
  '/manifest.json',
  '/icon-192.png',
  '/icon-512.png'
];
...
const CRITICAL=new Set([
  '/auth-bootstrap.js','/start-dashboard-71510.js','/start-dashboard-8285.js','/global-dashboard-nav-8290.js','/contessa-start-icon-8290.js','/dashboard-unified-71919-loader.js','/approved-dashboard-8263.js','/approved-dashboard-live-8264.js','/dashboard-victron-live-8310.js','/victron-tank-alarm-8278.js','/settings-notifications-8279.js','/serenity-alarm-notifications-71826.js','/dashboard-buttons-8265.js','/ai-quick-command-8267.js','/rws-water-temp-8233.js','/receipt-reader-pro.js','/receipt-ocr-fix-8234.js','/receipt-ai-first.js','/serenity-dashboard-boat-20260909.webp','/serenity-dashboard-boat-20260926.webp'
]);
