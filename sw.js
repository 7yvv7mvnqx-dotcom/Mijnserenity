/* MijnSerenity 8.27.8 — consistente releasecache voor web en native bronassets */
const CACHE_NAME='mijnserenity-8.27.8';
const BUILD='8.27.8';
const TOKEN='827800';
const CORE=[
  '/',
