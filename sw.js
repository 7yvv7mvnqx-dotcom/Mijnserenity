/* MijnSerenity 8.30.10 — consistente releasecache en verse alarmbediening */
const CACHE_NAME='mijnserenity-8.30.10';
const BUILD='8.30.10';
const TOKEN='830100';
const CORE=[
  '/',
