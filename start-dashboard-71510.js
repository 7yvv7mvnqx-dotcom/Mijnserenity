/* MijnSerenity 8.27.8 — stabiele Gerard + Victron tank/alarm sync + veilige iOS antwoordstem. */
(()=>{
'use strict';
...
const BUILD='8.27.8',TOKEN='827800',ROOT='ms8210Start';
const APPROVED='ms8266ApprovedScript',PATCH='ms8266DashboardButtonsScript',LIVE='ms8266DashboardLiveScript',VIC='ms8278VictronTankAlarmScript',AI='ms8266QuickAskScript',VOICE='ms8271AiVoiceScript',IOSVOICE='ms8277IosVoiceFixScript',PERSIST='ms8272AiPersistScript';
...
function announceReady(){if(readyAnnounced)return;readyAnnounced=true;window.__msApprovedHomeReady8278=true;window.dispatchEvent(new CustomEvent('mijnserenity:dashboard-ready',{detail:{build:BUILD,approved:true,singleRenderer:true,source:'start-dashboard-8278'}}))}
...
function finish(){try{window.ms8263ApplyApprovedDashboard?.()}catch(_){};ensurePatch();ensureLive();ensureVictron();ensureAi();syncBuild();announceReady()}
