/* MijnSerenity 8.27.9 — instelbare alarmen + Victron tank/alarm sync + veilige iOS antwoordstem. */
(()=>{
'use strict';
...
const BUILD='8.27.9',TOKEN='827900',ROOT='ms8210Start';
...
function announceReady(){if(readyAnnounced)return;readyAnnounced=true;window.__msApprovedHomeReady8279=true;window.dispatchEvent(new CustomEvent('mijnserenity:dashboard-ready',{detail:{build:BUILD,approved:true,singleRenderer:true,source:'start-dashboard-8279'}}))}
