/* MijnSerenity 8.28.1 — veilige Serenity hero: geen observer-loop. */
(()=>{
  'use strict';
  if(window.__msSerenityHeroCrop8281)return;
  window.__msSerenityHeroCrop8281=true;

  const STYLE_ID='msSerenityHeroCrop8281Style';
  const CSS=`
